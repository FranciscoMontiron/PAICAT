...
return [
    ...
    'default' => env('DB_CONNECTION', 'paicat'),
    ...
    'connections' => [
        ...
        // PAICAT - Base de datos principal (Lectura/Escritura)
        'paicat' => [
            'driver' => 'mysql',
            'url' => env('DB_URL'),
            'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_DATABASE_PAICAT', 'paicat'),
            'username' => env('DB_USERNAME', 'root'),
            'password' => env('DB_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
    ...
    | que también proporciona un conjunto más rico de comandos que un sistema
    | típico de clave-valor como Memcached. Puedes definir tu configuración aquí.
    |
    */
