            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="direccion" id="direccion" value="{{ old('direccion', $municipio->direccion) }}"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-utn-blue focus:border-transparent @error('direccion') border-red-500 @enderror"
