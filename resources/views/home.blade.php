        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-utn-blue mt-1">{{ $stats['inscripciones'] }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-green-600 mt-1">{{ $stats['alumnos_cursando'] }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-utn-orange mt-1">{{ $stats['comisiones_activas'] }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-indigo-600 mt-1">{{ $stats['municipios'] }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-purple-600 mt-1">{{ $stats['aulas'] }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="p-4 space-y-2">
                <a href="{{ route('inscripciones.index') }}" class="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors group">
                    ...
                    <div class="flex-1">
                        <p class="font-medium text-gray-900 group-hover:text-blue-600">Inscripciones</p>
                ...
                <a href="{{ route('trayectorias.index') }}" class="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors group">
                    <div class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
                        <svg class="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex-1">
                        <p class="font-medium text-gray-900 group-hover:text-blue-600">Trayectorias</p>
                        <p class="text-xs text-gray-500">Seguimiento académico de estudiantes</p>
                    </div>
                    <svg class="w-5 h-5 text-gray-300 group-hover:text-blue-500 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
                ...
                <a href="{{ route('cursadas.global') }}" class="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors group">
                    <div class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
                        <svg class="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex-1">
                        <p class="font-medium text-gray-900 group-hover:text-blue-600">Cursadas</p>
                        <p class="text-xs text-gray-500">Estado de cursadas por alumno</p>
                    </div>
                    <svg class="w-5 h-5 text-gray-300 group-hover:text-blue-500 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    </svg>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="p-4 space-y-2">
                <a href="{{ route('comisiones.index') }}" class="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors group">
                    ...
                    <div class="flex-1">
                        <p class="font-medium text-gray-900 group-hover:text-green-600">Comisiones</p>
                ...
                <a href="{{ route('evaluaciones.index') }}" class="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors group">
                    ...
                    <div class="flex-1">
                        <p class="font-medium text-gray-900 group-hover:text-green-600">Evaluaciones</p>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="p-4 space-y-2">
                <a href="{{ route('municipios.index') }}" class="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors group">
                    ...
                    <div class="flex-1">
                        <p class="font-medium text-gray-900 group-hover:text-purple-600">Municipios / Sedes</p>
                ...
                <a href="{{ route('aulas.index') }}" class="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors group">
                    ...
                    <div class="flex-1">
                        <p class="font-medium text-gray-900 group-hover:text-purple-600">Aulas</p>
                ...
                <a href="{{ route('materias.index') }}" class="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors group">
                    ...
                    <div class="flex-1">
                        <p class="font-medium text-gray-900 group-hover:text-purple-600">Materias</p>
