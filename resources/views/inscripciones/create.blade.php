...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    {{-- Aviso BD alumnos no disponible --}}
    @if(!($alumnosUtnDisponible ?? true))
    <div class="bg-amber-50 border-l-4 border-amber-500 p-4 mb-6 rounded-r-lg">
        <div class="flex">
            ...
            <div class="ml-3">
                <p class="text-sm font-semibold text-amber-800">Base de datos de alumnos no disponible</p>
                <p class="text-sm text-amber-700 mt-1 whitespace-pre-line">{{ $alumnosUtnMensaje }}</p>
            </div>
        </div>
    </div>
    @endif
