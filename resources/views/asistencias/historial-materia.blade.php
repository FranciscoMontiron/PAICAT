...
<div class="container mx-auto px-4 py-6">
    ...
    <!-- Historial por Fecha (Opcional, colapsable) -->
    @if($fechasClases->count() > 0)
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="bg-gray-50 px-6 py-4 border-b border-gray-200 cursor-pointer" onclick="toggleHistorialFechas()">
            <div class="flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-800">Historial por Fecha ({{ $fechasClases->count() }} clases)</h3>
                <svg id="historialChevron" class="w-5 h-5 text-gray-500 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                </svg>
            </div>
        </div>
        <div id="historialFechas" class="hidden p-6">
            <div class="space-y-4">
...
<script>
function toggleHistorialFechas() {
    const historial = document.getElementById('historialFechas');
