    ...
    <div class="bg-white border-b border-gray-200 shadow-sm sm:rounded-lg">
        <div class="p-6">
            ...
            <div class="flex justify-between items-start mb-6">
                <div>
                    <h1 class="text-3xl font-bold text-utn-blue-dark">{{ $comision->nombre }}</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <a href="{{ route('asistencias.registrar', $comision->id) }}" 
                   class="flex items-center justify-center gap-2 p-4 bg-green-500 text-white rounded-lg hover:bg-green-800 transition shadow-sm font-medium">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <a href="{{ route('asistencias.justificar', $comision->id) }}" 
                   class="flex items-center justify-center gap-2 p-4 bg-blue-500 text-white rounded-lg hover:bg-utn-blue-darker transition shadow-sm font-medium">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
