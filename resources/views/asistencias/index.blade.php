    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3">
                <a href="{{ route('asistencias.por-materia') }}"
                    class="flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition shadow-sm">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                @endphp
                <div class="border rounded-lg p-5 hover:shadow-lg transition duration-200 {{ $esPresencial ? 'border-gray-200' : 'border-gray-200 bg-gray-50' }}">
                    <!-- Header Comisión -->
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <p class="text-xs font-medium text-gray-500 mb-2">Materias:</p>
                        <div class="flex flex-wrap gap-1">
                            @foreach($comision->materias->take(3) as $materia)
                            <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-indigo-100 text-indigo-800">
                                {{ Str::limit($materia->nombre, 15) }}
                            </span>
                            @endforeach
                            @if($comision->materias->count() > 3)
                            <span class="text-xs text-gray-500">+{{ $comision->materias->count() - 3 }} más</span>
                            @endif
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        @else
                            <div class="text-center py-2">
                                <p class="text-xs text-gray-500">No se registra asistencia en comisiones {{ strtolower($comision->modalidad ?? 'no presenciales') }}</p>
                            </div>
                            <a href="{{ route('asistencias.historial', $comision) }}"
                                class="w-full bg-blue-600 hover:bg-blue-700 text-white text-center px-3 py-2 rounded-lg transition duration-200 text-sm font-medium flex items-center justify-center">
                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                                </svg>
