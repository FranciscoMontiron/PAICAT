...
<div class="container mx-auto p-4">
    ...
    <div class="flex items-center gap-2 text-sm text-gray-600 mb-4">
        ...
        <span class="text-gray-800 font-medium">Alertas</span>
    </div>

    <div class="bg-white border-b border-gray-200 shadow-sm sm:rounded-lg">
        <div class="p-6">
            
            <!-- Encabezado con ícono de alerta -->
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex-1">
                                    ...
                                    <div class="flex flex-wrap gap-4 text-sm text-gray-700">
                                        <span>
                                            <strong>Comisión:</strong> {{ $inscripcion->comision->nombre ?? '-' }}
                                        </span>
                                        <span>
                                            <strong>Turno:</strong> {{ $inscripcion->comision->turno ?? '-' }}
                                        </span>
                                        <span>
                                            <strong>Total Asistencias:</strong> {{ $inscripcion->asistencias->count() }}
                                        </span>
                                    </div>
                                </div>
