...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-gray-900">Editar Aula</h1>
        <p class="text-gray-600 mt-1">Modifica los datos del aula {{ $aula->nombre }}</p>
    </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <select name="municipio_id" id="municipio_id" required
                        ...
                        <option value="{{ $municipio->id }}" {{ old('municipio_id', $aula->municipio_id) == $municipio->id ? 'selected' : '' }}>
                            {{ $municipio->nombre }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="capacidad" id="capacidad" value="{{ old('capacidad', $aula->capacidad) }}" min="1" max="500"
                ...
                <div class="flex items-center gap-3">
                    <input type="checkbox" name="activa" id="activa" value="1"
                           ...
                           {{ old('activa', $aula->activa) ? 'checked' : '' }}>
                ...
                <div>
                    ...
                    <textarea name="observaciones" id="observaciones" rows="3"
                              ...
                              placeholder="Notas adicionales...">{{ old('observaciones', $aula->observaciones) }}</textarea>
                    @error('observaciones')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
