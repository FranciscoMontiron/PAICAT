            ...
            <nav class="bg-utn-blue-dark border-t border-white/10">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="hidden md:flex space-x-1 py-1">
                        ...
                        {{-- Materias --}}
                        @if(auth()->user()->hasPermission('comisiones.ver'))
                        <a href="{{ route('materias.index') }}" class="px-4 py-2.5 text-sm font-medium rounded-t-lg transition-all duration-200 {{ request()->routeIs('materias.*') ? 'bg-white text-utn-blue' : 'text-white hover:bg-white/10' }}">
                            <span class="flex items-center gap-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {{-- Trayectorias --}}
                        @if(auth()->user()->hasPermission('inscripciones.ver'))
                        <a href="{{ route('trayectorias.index') }}" class="px-4 py-2.5 text-sm font-medium rounded-t-lg transition-all duration-200 {{ request()->routeIs('trayectorias.*') || request()->routeIs('solicitudes.*') ? 'bg-white text-utn-blue' : 'text-white hover:bg-white/10' }}">
                            <span class="flex items-center gap-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
