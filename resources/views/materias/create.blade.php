...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-gray-900">Nueva Materia</h1>
        <p class="text-gray-600 mt-1">Registra una nueva materia del curso de ingreso</p>
    </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="nombre" id="nombre" value="{{ old('nombre') }}" required
                           ...
                           placeholder="Ej: Matematica, Fisica, Introduccion a la Vida Universitaria">
                    @error('nombre')
                ...
                <div class="flex flex-wrap gap-6">
                    <div class="flex items-center gap-3">
                        <input type="checkbox" name="es_nivelacion" id="es_nivelacion" value="1"
                               ...
                               {{ old('es_nivelacion', true) ? 'checked' : '' }}>
                ...
                <div>
                    ...
                    <textarea name="descripcion" id="descripcion" rows="3"
                              ...
                              placeholder="Contenidos principales, objetivos...">{{ old('descripcion') }}</textarea>
                    @error('descripcion')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
