    ...
    <div class="p-6 bg-white border-b border-gray-200">
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <a href="{{ route('reportes.reporteasistenciascomision') }}" class="group bg-white rounded-lg shadow-sm border border-gray-200 p-5 hover:border-utn-blue hover:shadow-md transition-all duration-200">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            <h3 class="font-semibold text-gray-900 group-hover:text-utn-blue transition-colors">Reportes</h3>
                            <p class="text-sm text-gray-500 mt-1">Rportes de asistencias por comision </p>
                        </div>
